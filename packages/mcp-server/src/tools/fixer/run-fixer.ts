    ...
    properties: {
      ...
      fix_types: {
        ...
        items: {
          ...
          title: 'FixTypeName',
          description: 'Enumeration of available fix types',
          enum: ['import_export', 'string_literals', 'css', 'ai_fallback', 'types', 'ui_rules', 'sql'],
        },
      },
      fixes: {
        type: 'object',
